...
function get_resource_value(rid, model) {
  return Curry._2(Overbots_types.ResourceMap[/* find */21], rid, model[/* resource_values */1]);
}
...
function set_resource_value(rid, value, model) {
  ...
  if (value < match[0]) {
    ...
    var rmax = match[1];
    if (value > rmax) {
      var resource_values = Curry._3(Overbots_types.ResourceMap[/* add */3], rid, rmax, model[/* resource_values */1]);
      return /* ValueTooHigh */Block.__(0, [
                /* record */[
                  /* msgs */model[/* msgs */0],
                  /* resource_values */resource_values,
                  /* bool_flags */model[/* bool_flags */2],
                  /* int_flags */model[/* int_flags */3]
                ],
                value - rmax
              ]);
    } else {
      var resource_values$1 = Curry._3(Overbots_types.ResourceMap[/* add */3], rid, value, model[/* resource_values */1]);
      return /* ValueSuccess */Block.__(1, [/* record */[
                  /* msgs */model[/* msgs */0],
