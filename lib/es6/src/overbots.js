...
function init() {
  ...
  var load_data_task = Curry._1(Tea_ex.LocalStorage[/* getItem */0], serialized_name);
  return /* tuple */[
          model,
          Tea_cmd.batch(/* :: */[
...
function update(model, param) {
  if (typeof param === "number") {
    ...
    return /* tuple */[
            model,
            Tea_task.performOpt(function () {
                  return /* None */0;
                }, Curry._2(Tea_ex.LocalStorage[/* setItem */1], serialized_name, json_string))
          ];
  } else {
    switch (param.tag | 0) {
      case 0 : 
          ...
          if (json_string$1 === "") {
            ...
            if (match.tag) {
              return /* tuple */[
                      ...
                      Tea_task.performOpt(function () {
                            return /* None */0;
                          }, Curry._2(Tea_ex.LocalStorage[/* setItem */1], serialized_name, ""))
                    ];
            } else {
              return /* tuple */[
                      match[0],
