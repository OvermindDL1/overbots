...
function perform_actions(model, actions) {
  return List.fold_left(perform_action, model, actions);
}
...
var timeactions = /* array */[
  ...
  /* record */[
    ...
    /* actions : :: */[
      ...
      /* :: */[
        /* ActionAddMsg */Block.__(0, ["Touchdown!  Landing assembly is unfolding.  I now need to deploy my solar energy collectors."]),
        /* [] */0
      ]
    ]
  ],
...
function update_timeactions(model, time) {
  ...
  if (time < match[/* at */0]) {
    ...
    var model$1 = List.fold_left(perform_action, model, match[/* actions */1]);
