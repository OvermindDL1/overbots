...
function view_resources_category_resource(model, r) {
  ...
  if (Curry._1(r[/* shown */1], model)) {
    ...
    var delta = format_value(Curry._2(Overbots_types.ResourceMap[/* find */21], rid, model[/* cache */8][/* resource_deltas */1]));
    return /* :: */[
            Tea_html.div(/* None */0, /* None */0, /* :: */[
                  Tea_html.class$prime("resource resource-" + r[/* idname */3]),
                  /* [] */0
                ], /* :: */[
                  Tea_html.div(/* None */0, /* None */0, /* :: */[
                        ...
                        Tea_html.text(Curry._1(r[/* name */4], model)),
                        /* [] */0
                      ]),
                  /* :: */[
                    Tea_html.div(/* None */0, /* None */0, /* :: */[
                    ...
                    /* :: */[
                      Tea_html.div(/* None */0, /* None */0, /* :: */[
                            Tea_html.class$prime("resource-delta"),
                            /* [] */0
                          ], /* :: */[
                            Tea_html.text(delta),
                            /* :: */[
...
function view_button(model, param) {
  var bid = param[0];
  if (Overbots_buttons.button_enabled(model, bid)) {
    return /* :: */[
            Tea_html.button(/* None */0, /* None */0, /* :: */[
                  Tea_html.onClick(/* ActionButtonClicked */Block.__(1, [bid])),
                  /* :: */[
                    Curry._1(Tea_html.Attributes[/* disabled */3], Overbots_buttons.button_temporarily_disabled(model, bid)),
                    /* :: */[
                      Tea_html.class$prime("action action-" + param[1]),
                      /* [] */0
                    ]
                  ]
                ], /* :: */[
                  Tea_html.text(param[2]),
                  /* [] */0
                ]),
            /* [] */0
          ];
...
function view_buttons_category(model, param) {
  ...
  if (children) {
    var children_000 = Tea_html.div(/* None */0, /* None */0, /* :: */[
          Tea_html.class$prime("category-title"),
          /* [] */0
        ], /* :: */[
    ...
    return /* :: */[
            Tea_html.div(/* None */0, /* None */0, /* :: */[
                  Tea_html.class$prime("action-category action-category-" + param[1]),
                  /* [] */0
                ], children$1),
            /* [] */0
          ];
...
function view_buttons(model) {
  return List.flatten(List.map(function (param) {
                ...
                }, Overbots_buttons.displayed_buttons));
}
...
function view_msg(_, param) {
  return Tea_html.div(/* None */0, /* None */0, /* :: */[
              Tea_html.class$prime("msg"),
              /* [] */0
            ], /* :: */[
              Tea_html.text(Pervasives.string_of_int(0.5 + param[0] | 0)),
              /* :: */[
                Tea_html.text(": "),
                /* :: */[
